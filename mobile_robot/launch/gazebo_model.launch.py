...
def generate_launch_description():
    ...
    robotXacroName = 'auto_turret_vehicle'

    namePackage = 'mobile_robot'

    modelFileRelativePath = 'model/robot.xacro'
    worldFileRelativePath = 'model/cars.world'
    ...
    start_turret_controller_cmd = Node(
    ...
    launchDescriptionObject.add_action(start_turret_controller_cmd)
    launchDescriptionObject.add_action(start_joint_state_broadcaster_cmd)
